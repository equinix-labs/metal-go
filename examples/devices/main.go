...
func main() {
	...
	if err != nil {
		...
		fmt.Printf("FindDeviceById, Device ID %v, project ID %v", *device.Id, device.Project.Href.Href)
		...
		if err != nil {
			...
			fmt.Printf("FindByHref, Device ID %v, project ID %v", *device.Id, *device.Project.Project.Id)
		}
	}
}
