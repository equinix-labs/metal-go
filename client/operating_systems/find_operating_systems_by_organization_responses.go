...
/* FindOperatingSystemsByOrganizationOK describes a response with status code 200, with default header values.
...
/* FindOperatingSystemsByOrganizationUnauthorized describes a response with status code 401, with default header values.
...
/* FindOperatingSystemsByOrganizationForbidden describes a response with status code 403, with default header values.
...
/* FindOperatingSystemsByOrganizationNotFound describes a response with status code 404, with default header values.
