...
func (o *CreateVolumeAttachmentParams) WithTimeout(timeout time.Duration) *CreateVolumeAttachmentParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the create volume attachment params
func (o *CreateVolumeAttachmentParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the create volume attachment params
func (o *CreateVolumeAttachmentParams) WithContext(ctx context.Context) *CreateVolumeAttachmentParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the create volume attachment params
func (o *CreateVolumeAttachmentParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the create volume attachment params
func (o *CreateVolumeAttachmentParams) WithHTTPClient(client *http.Client) *CreateVolumeAttachmentParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the create volume attachment params
func (o *CreateVolumeAttachmentParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}
...
// WithID adds the id to the create volume attachment params
func (o *CreateVolumeAttachmentParams) WithID(id strfmt.UUID) *CreateVolumeAttachmentParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the create volume attachment params
func (o *CreateVolumeAttachmentParams) SetID(id strfmt.UUID) {
	o.ID = id
}

// WriteToRequest writes these params to a swagger request
func (o *CreateVolumeAttachmentParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
