...
/* DeleteVolumeSnapshotPolicyNoContent describes a response with status code 204, with default header values.
...
/* DeleteVolumeSnapshotPolicyUnauthorized describes a response with status code 401, with default header values.
...
/* DeleteVolumeSnapshotPolicyForbidden describes a response with status code 403, with default header values.
...
/* DeleteVolumeSnapshotPolicyNotFound describes a response with status code 404, with default header values.
