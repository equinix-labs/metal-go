...
// WithExclude adds the exclude to the find organizations params
func (o *FindOrganizationsParams) WithExclude(exclude []string) *FindOrganizationsParams {
	o.SetExclude(exclude)
	return o
}

// SetExclude adds the exclude to the find organizations params
func (o *FindOrganizationsParams) SetExclude(exclude []string) {
	o.Exclude = exclude
}
...
func (o *FindOrganizationsParams) WithPage(page *int32) *FindOrganizationsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the find organizations params
func (o *FindOrganizationsParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the find organizations params
func (o *FindOrganizationsParams) WithPerPage(perPage *int32) *FindOrganizationsParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the find organizations params
func (o *FindOrganizationsParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
...
// bindParamFindOrganizations binds the parameter exclude
func (o *FindOrganizationsParams) bindParamExclude(formats strfmt.Registry) []string {
	excludeIR := o.Exclude
...
// bindParamFindOrganizations binds the parameter include
func (o *FindOrganizationsParams) bindParamInclude(formats strfmt.Registry) []string {
	includeIR := o.Include
