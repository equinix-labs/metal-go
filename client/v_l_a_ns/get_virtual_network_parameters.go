...
for the get virtual network operation typically these are written to a http.Request
*/
...
func (o *GetVirtualNetworkParams) WithID(id strfmt.UUID) *GetVirtualNetworkParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get virtual network params
func (o *GetVirtualNetworkParams) SetID(id strfmt.UUID) {
	o.ID = id
}
