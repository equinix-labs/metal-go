...
// New creates a new operating system versions API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for operating system versions API
*/
type Client struct {
...
/*
  FindOperatingSystemVersion retrieves all operating system versions
...
func (a *Client) FindOperatingSystemVersion(params *FindOperatingSystemVersionParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*FindOperatingSystemVersionOK, error) {
	...
	success, ok := result.(*FindOperatingSystemVersionOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for findOperatingSystemVersion: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
