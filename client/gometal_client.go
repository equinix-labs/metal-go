...
import (
	...
	"github.com/t0mk/gometal/client/b_g_p"
	...
	"github.com/t0mk/gometal/client/v_p_n"
	"github.com/t0mk/gometal/client/volumes"
)

// Default gometal HTTP client.
...
// NewHTTPClient creates a new gometal HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Gometal {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new gometal HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Gometal {
...
// New creates a new gometal client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Gometal {
	// ensure nullable parameters have default
	if formats == nil {
	...
	cli.Bgp = b_g_p.New(transport, formats)
	...
	cli.Vpn = v_p_n.New(transport, formats)
...
// Gometal is a client for gometal
type Gometal struct {
	Bgp b_g_p.ClientService
...
func (c *Gometal) SetTransport(transport runtime.ClientTransport) {
