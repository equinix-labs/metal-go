...
/* FindIPAddressCustomdataOK describes a response with status code 200, with default header values.
...
/* FindIPAddressCustomdataUnauthorized describes a response with status code 401, with default header values.
...
/* FindIPAddressCustomdataForbidden describes a response with status code 403, with default header values.
...
/* FindIPAddressCustomdataNotFound describes a response with status code 404, with default header values.
