...
/* FindDeviceSSHKeysOK describes a response with status code 200, with default header values.
...
func (o *FindDeviceSSHKeysOK) GetPayload() *types.SSHKeyList {
	return o.Payload
}
...
/* FindDeviceSSHKeysUnauthorized describes a response with status code 401, with default header values.
