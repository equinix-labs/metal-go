...
// WithExclude adds the exclude to the find project licenses params
func (o *FindProjectLicensesParams) WithExclude(exclude []string) *FindProjectLicensesParams {
	o.SetExclude(exclude)
	return o
}

// SetExclude adds the exclude to the find project licenses params
func (o *FindProjectLicensesParams) SetExclude(exclude []string) {
	o.Exclude = exclude
}
...
func (o *FindProjectLicensesParams) WithPage(page *int32) *FindProjectLicensesParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the find project licenses params
func (o *FindProjectLicensesParams) SetPage(page *int32) {
	o.Page = page
}

// WithPerPage adds the perPage to the find project licenses params
func (o *FindProjectLicensesParams) WithPerPage(perPage *int32) *FindProjectLicensesParams {
	o.SetPerPage(perPage)
	return o
}

// SetPerPage adds the perPage to the find project licenses params
func (o *FindProjectLicensesParams) SetPerPage(perPage *int32) {
	o.PerPage = perPage
}
...
// bindParamFindProjectLicenses binds the parameter exclude
func (o *FindProjectLicensesParams) bindParamExclude(formats strfmt.Registry) []string {
	excludeIR := o.Exclude
...
// bindParamFindProjectLicenses binds the parameter include
func (o *FindProjectLicensesParams) bindParamInclude(formats strfmt.Registry) []string {
	includeIR := o.Include
