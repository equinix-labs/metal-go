...
/* FindBGPSessionByIDParams contains all the parameters to send to the API endpoint
   for the find Bgp session by Id operation.
...
// WithDefaults hydrates default values in the find Bgp session by Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindBGPSessionByIDParams) WithDefaults() *FindBGPSessionByIDParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the find Bgp session by Id params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *FindBGPSessionByIDParams) SetDefaults() {
...
// WithExclude adds the exclude to the find Bgp session by Id params
func (o *FindBGPSessionByIDParams) WithExclude(exclude []string) *FindBGPSessionByIDParams {
	o.SetExclude(exclude)
	return o
}

// SetExclude adds the exclude to the find Bgp session by Id params
func (o *FindBGPSessionByIDParams) SetExclude(exclude []string) {
	o.Exclude = exclude
}
...
// bindParamFindBGPSessionByID binds the parameter exclude
func (o *FindBGPSessionByIDParams) bindParamExclude(formats strfmt.Registry) []string {
	excludeIR := o.Exclude
...
// bindParamFindBGPSessionByID binds the parameter include
func (o *FindBGPSessionByIDParams) bindParamInclude(formats strfmt.Registry) []string {
	includeIR := o.Include
