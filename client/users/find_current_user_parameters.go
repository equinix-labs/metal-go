...
// WithExclude adds the exclude to the find current user params
func (o *FindCurrentUserParams) WithExclude(exclude []string) *FindCurrentUserParams {
	o.SetExclude(exclude)
	return o
}

// SetExclude adds the exclude to the find current user params
func (o *FindCurrentUserParams) SetExclude(exclude []string) {
	o.Exclude = exclude
}
...
// bindParamFindCurrentUser binds the parameter exclude
func (o *FindCurrentUserParams) bindParamExclude(formats strfmt.Registry) []string {
	excludeIR := o.Exclude
...
// bindParamFindCurrentUser binds the parameter include
func (o *FindCurrentUserParams) bindParamInclude(formats strfmt.Registry) []string {
	includeIR := o.Include
