...
type UpdateInterconnectionReader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *UpdateInterconnectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewUpdateInterconnectionOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 403:
		result := NewUpdateInterconnectionForbidden()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	case 404:
		result := NewUpdateInterconnectionNotFound()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
// NewUpdateInterconnectionOK creates a UpdateInterconnectionOK with default headers values
func NewUpdateInterconnectionOK() *UpdateInterconnectionOK {
...
// NewUpdateInterconnectionForbidden creates a UpdateInterconnectionForbidden with default headers values
func NewUpdateInterconnectionForbidden() *UpdateInterconnectionForbidden {
...
forbidden
*/
type UpdateInterconnectionForbidden struct {
}
...
// NewUpdateInterconnectionNotFound creates a UpdateInterconnectionNotFound with default headers values
func NewUpdateInterconnectionNotFound() *UpdateInterconnectionNotFound {
...
not found
*/
type UpdateInterconnectionNotFound struct {
}
