 ...
 */
func (a *UsersApiService) FindInvitations(ctx _context.Context) ApiFindInvitationsRequest {
	return ApiFindInvitationsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *UsersApiService) FindInvitationsExecute(r ApiFindInvitationsRequest) (InvitationList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
