 ...
 */
func (a *ConnectionsApiService) FindConnectionEvents(ctx _context.Context, connectionId string) ApiFindConnectionEventsRequest {
	return ApiFindConnectionEventsRequest{
		ApiService: a,
		ctx: ctx,
		connectionId: connectionId,
 ...
 * @return Event
 */
func (a *ConnectionsApiService) FindConnectionEventsExecute(r ApiFindConnectionEventsRequest) (Event, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConnectionsApiService.FindConnectionEvents")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *ConnectionsApiService) FindConnectionPortEvents(ctx _context.Context, connectionId string, id string) ApiFindConnectionPortEventsRequest {
	return ApiFindConnectionPortEventsRequest{
		ApiService: a,
		ctx: ctx,
		connectionId: connectionId,
 ...
 * @return Event
 */
func (a *ConnectionsApiService) FindConnectionPortEventsExecute(r ApiFindConnectionPortEventsRequest) (Event, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConnectionsApiService.FindConnectionPortEvents")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
 ...
 */
func (a *ConnectionsApiService) FindVirtualCircuitEvents(ctx _context.Context, id string) ApiFindVirtualCircuitEventsRequest {
	return ApiFindVirtualCircuitEventsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return Event
 */
func (a *ConnectionsApiService) FindVirtualCircuitEventsExecute(r ApiFindVirtualCircuitEventsRequest) (Event, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ConnectionsApiService.FindVirtualCircuitEvents")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
