 ...
 */
func (a *DevicesApiService) FindDeviceEvents(ctx _context.Context, id string) ApiFindDeviceEventsRequest {
	return ApiFindDeviceEventsRequest{
		ApiService: a,
		ctx: ctx,
		id: id,
 ...
 * @return EventList
 */
func (a *DevicesApiService) FindDeviceEventsExecute(r ApiFindDeviceEventsRequest) (EventList, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DevicesApiService.FindDeviceEvents")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}
