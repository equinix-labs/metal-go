...
// ContextValidate validates this timeframe based on context it is used
func (m *Timeframe) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
