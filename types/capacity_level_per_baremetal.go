...
// ContextValidate validates this capacity level per baremetal based on context it is used
func (m *CapacityLevelPerBaremetal) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
