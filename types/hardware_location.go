...
// ContextValidate validates this hardware location based on context it is used
func (m *HardwareLocation) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
