...
// ContextValidate validates this event input based on context it is used
func (m *EventInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
