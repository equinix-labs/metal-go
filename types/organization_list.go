...
func (m *OrganizationList) contextValidateMeta(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OrganizationList) contextValidateOrganizations(ctx context.Context, formats strfmt.Registry) error {
