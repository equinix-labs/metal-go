...
// ContextValidate validates this payment method create input based on context it is used
func (m *PaymentMethodCreateInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
