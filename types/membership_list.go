...
// Validate validates this membership list
func (m *MembershipList) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MembershipList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MembershipList) UnmarshalBinary(b []byte) error {
	var res MembershipList
