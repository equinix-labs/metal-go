...
// ContextValidate validates this interconnection create input based on context it is used
func (m *InterconnectionCreateInput) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
