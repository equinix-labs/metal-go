...
// ContextValidate validate this capacity per new facility based on the context it is used
func (m *CapacityPerNewFacility) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CapacityPerNewFacility) contextValidateBaremetal1e(ctx context.Context, formats strfmt.Registry) error {
