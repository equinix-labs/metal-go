...
// ContextValidate validate this capacity server unavailable based on the context it is used
func (m *CapacityServerUnavailable) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CapacityServerUnavailable) contextValidateServers(ctx context.Context, formats strfmt.Registry) error {
