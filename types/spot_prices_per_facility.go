...
// ContextValidate validate this spot prices per facility based on the context it is used
func (m *SpotPricesPerFacility) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *SpotPricesPerFacility) contextValidateBaremetal0(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetal1(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetal2(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetal2a(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetal2a2(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetal3(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateBaremetals(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateC2MediumX86(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SpotPricesPerFacility) contextValidateM2XlargeX86(ctx context.Context, formats strfmt.Registry) error {
