...
func (m *LicenseList) validateLicenses(formats strfmt.Registry) error {
...
// ContextValidate validate this license list based on the context it is used
func (m *LicenseList) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *LicenseList) contextValidateLicenses(ctx context.Context, formats strfmt.Registry) error {
...
func (m *LicenseList) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *LicenseList) UnmarshalBinary(b []byte) error {
	var res LicenseList
