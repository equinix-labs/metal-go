...
// FacilityMetro struct for FacilityMetro
type FacilityMetro struct {
...
func (o FacilityMetro) MarshalJSON() ([]byte, error) {
...
type NullableFacilityMetro struct {
	value *FacilityMetro
	isSet bool
}

func (v NullableFacilityMetro) Get() *FacilityMetro {
	return v.value
}

func (v *NullableFacilityMetro) Set(val *FacilityMetro) {
	v.value = val
	v.isSet = true
}

func (v NullableFacilityMetro) IsSet() bool {
	return v.isSet
}

func (v *NullableFacilityMetro) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFacilityMetro(val *FacilityMetro) *NullableFacilityMetro {
	return &NullableFacilityMetro{value: val, isSet: true}
}

func (v NullableFacilityMetro) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFacilityMetro) UnmarshalJSON(src []byte) error {
	v.isSet = true
