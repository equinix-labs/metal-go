...
func NewCheckCapacityForMetroRequest() *CheckCapacityForMetroRequest {
	this := CheckCapacityForMetroRequest{}
	return &this
}
...
type NullableCheckCapacityForMetroRequest struct {
	value *CheckCapacityForMetroRequest
	isSet bool
}

func (v NullableCheckCapacityForMetroRequest) Get() *CheckCapacityForMetroRequest {
	return v.value
}

func (v *NullableCheckCapacityForMetroRequest) Set(val *CheckCapacityForMetroRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCheckCapacityForMetroRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCheckCapacityForMetroRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCheckCapacityForMetroRequest(val *CheckCapacityForMetroRequest) *NullableCheckCapacityForMetroRequest {
	return &NullableCheckCapacityForMetroRequest{value: val, isSet: true}
}
