...
*/
func (a *CapacityApiService) FindOrganizationCapacityPerFacility(ctx context.Context, organizationId string) ApiFindOrganizationCapacityPerFacilityRequest {
	return ApiFindOrganizationCapacityPerFacilityRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *CapacityApiService) FindOrganizationCapacityPerFacilityExecute(r ApiFindOrganizationCapacityPerFacilityRequest) (*CapacityList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/capacity"
...
*/
func (a *CapacityApiService) FindOrganizationCapacityPerMetro(ctx context.Context, organizationId string) ApiFindOrganizationCapacityPerMetroRequest {
	return ApiFindOrganizationCapacityPerMetroRequest{
		ApiService:     a,
		ctx:            ctx,
		organizationId: organizationId,
...
func (a *CapacityApiService) FindOrganizationCapacityPerMetroExecute(r ApiFindOrganizationCapacityPerMetroRequest) (*CapacityList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/capacity/metros"
	localVarPath = strings.Replace(localVarPath, "{"+"organization_id"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
