...
*/
func (a *InvoicesApiService) FindOrganizationInvoices(ctx context.Context, organizationId string) ApiFindOrganizationInvoicesRequest {
	return ApiFindOrganizationInvoicesRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *InvoicesApiService) FindOrganizationInvoicesExecute(r ApiFindOrganizationInvoicesRequest) (*InvoiceList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/invoices"
