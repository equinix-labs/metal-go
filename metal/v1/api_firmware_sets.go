...
*/
func (a *FirmwareSetsApiService) GetOrganizationFirmwareSets(ctx context.Context, organizationId string) ApiGetOrganizationFirmwareSetsRequest {
	return ApiGetOrganizationFirmwareSetsRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *FirmwareSetsApiService) GetOrganizationFirmwareSetsExecute(r ApiGetOrganizationFirmwareSetsRequest) (*FirmwareSetListResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/firmware-sets"
