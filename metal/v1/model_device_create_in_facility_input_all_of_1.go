...
// DeviceCreateInFacilityInputAllOf1 struct for DeviceCreateInFacilityInputAllOf1
type DeviceCreateInFacilityInputAllOf1 struct {
	...
	IpAddresses []DeviceCreateInFacilityInputAllOf1IpAddresses `json:"ip_addresses,omitempty"`
	...
	SshKeys         []DeviceCreateInFacilityInputAllOf1SshKeys `json:"ssh_keys,omitempty"`
...
func NewDeviceCreateInFacilityInputAllOf1(operatingSystem string, plan string) *DeviceCreateInFacilityInputAllOf1 {
	this := DeviceCreateInFacilityInputAllOf1{}
...
func (o *DeviceCreateInFacilityInputAllOf1) GetIpAddresses() []DeviceCreateInFacilityInputAllOf1IpAddresses {
	if o == nil || isNil(o.IpAddresses) {
		var ret []DeviceCreateInFacilityInputAllOf1IpAddresses
		return ret
	}
...
// SetIpAddresses gets a reference to the given []DeviceCreateInFacilityInputAllOf1IpAddresses and assigns it to the IpAddresses field.
...
func (o *DeviceCreateInFacilityInputAllOf1) GetSshKeys() []DeviceCreateInFacilityInputAllOf1SshKeys {
	if o == nil || isNil(o.SshKeys) {
		var ret []DeviceCreateInFacilityInputAllOf1SshKeys
		return ret
	}
	return o.SshKeys
}
...
// SetSshKeys gets a reference to the given []DeviceCreateInFacilityInputAllOf1SshKeys and assigns it to the SshKeys field.
...
func (o DeviceCreateInFacilityInputAllOf1) MarshalJSON() ([]byte, error) {
...
type NullableDeviceCreateInFacilityInputAllOf1 struct {
	value *DeviceCreateInFacilityInputAllOf1
	isSet bool
}

func (v NullableDeviceCreateInFacilityInputAllOf1) Get() *DeviceCreateInFacilityInputAllOf1 {
	return v.value
}

func (v *NullableDeviceCreateInFacilityInputAllOf1) Set(val *DeviceCreateInFacilityInputAllOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceCreateInFacilityInputAllOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceCreateInFacilityInputAllOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceCreateInFacilityInputAllOf1(val *DeviceCreateInFacilityInputAllOf1) *NullableDeviceCreateInFacilityInputAllOf1 {
	return &NullableDeviceCreateInFacilityInputAllOf1{value: val, isSet: true}
}

func (v NullableDeviceCreateInFacilityInputAllOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceCreateInFacilityInputAllOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true
