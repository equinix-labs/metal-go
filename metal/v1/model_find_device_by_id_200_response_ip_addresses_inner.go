...
func NewFindDeviceById200ResponseIpAddressesInner() *FindDeviceById200ResponseIpAddressesInner {
	this := FindDeviceById200ResponseIpAddressesInner{}
	return &this
}
...
func (o FindDeviceById200ResponseIpAddressesInner) MarshalJSON() ([]byte, error) {
...
type NullableFindDeviceById200ResponseIpAddressesInner struct {
	value *FindDeviceById200ResponseIpAddressesInner
	isSet bool
}

func (v NullableFindDeviceById200ResponseIpAddressesInner) Get() *FindDeviceById200ResponseIpAddressesInner {
	return v.value
}

func (v *NullableFindDeviceById200ResponseIpAddressesInner) Set(val *FindDeviceById200ResponseIpAddressesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableFindDeviceById200ResponseIpAddressesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableFindDeviceById200ResponseIpAddressesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindDeviceById200ResponseIpAddressesInner(val *FindDeviceById200ResponseIpAddressesInner) *NullableFindDeviceById200ResponseIpAddressesInner {
	return &NullableFindDeviceById200ResponseIpAddressesInner{value: val, isSet: true}
}

func (v NullableFindDeviceById200ResponseIpAddressesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFindDeviceById200ResponseIpAddressesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
