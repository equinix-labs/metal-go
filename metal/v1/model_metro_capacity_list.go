...
// checks if the MetroCapacityList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MetroCapacityList{}
...
func (o MetroCapacityList) ToMap() (map[string]interface{}, error) {
