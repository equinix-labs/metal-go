...
Deprecated
*/
func (a *FacilitiesApiService) FindFacilitiesByOrganization(ctx context.Context, organizationId string) ApiFindFacilitiesByOrganizationRequest {
	return ApiFindFacilitiesByOrganizationRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *FacilitiesApiService) FindFacilitiesByOrganizationExecute(r ApiFindFacilitiesByOrganizationRequest) (*FacilityList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/facilities"
