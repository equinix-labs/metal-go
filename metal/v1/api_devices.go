...
*/
func (a *DevicesApiService) FindOrganizationDevices(ctx context.Context, organizationId string) ApiFindOrganizationDevicesRequest {
	return ApiFindOrganizationDevicesRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *DevicesApiService) FindOrganizationDevicesExecute(r ApiFindOrganizationDevicesRequest) (*DeviceList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/devices"
