...
// CreateDeviceBatchRequestBatchesInnerAllOf struct for CreateDeviceBatchRequestBatchesInnerAllOf
type CreateDeviceBatchRequestBatchesInnerAllOf struct {
...
func NewCreateDeviceBatchRequestBatchesInnerAllOf() *CreateDeviceBatchRequestBatchesInnerAllOf {
	this := CreateDeviceBatchRequestBatchesInnerAllOf{}
	return &this
}
...
func (o CreateDeviceBatchRequestBatchesInnerAllOf) MarshalJSON() ([]byte, error) {
...
type NullableCreateDeviceBatchRequestBatchesInnerAllOf struct {
	value *CreateDeviceBatchRequestBatchesInnerAllOf
	isSet bool
}

func (v NullableCreateDeviceBatchRequestBatchesInnerAllOf) Get() *CreateDeviceBatchRequestBatchesInnerAllOf {
	return v.value
}

func (v *NullableCreateDeviceBatchRequestBatchesInnerAllOf) Set(val *CreateDeviceBatchRequestBatchesInnerAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeviceBatchRequestBatchesInnerAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeviceBatchRequestBatchesInnerAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeviceBatchRequestBatchesInnerAllOf(val *CreateDeviceBatchRequestBatchesInnerAllOf) *NullableCreateDeviceBatchRequestBatchesInnerAllOf {
	return &NullableCreateDeviceBatchRequestBatchesInnerAllOf{value: val, isSet: true}
}

func (v NullableCreateDeviceBatchRequestBatchesInnerAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDeviceBatchRequestBatchesInnerAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
