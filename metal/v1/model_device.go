...
type Device struct {
	...
	State        *DeviceStateFlexible `json:"state,omitempty"`
...
// SetState gets a reference to the given DeviceStateFlexible and assigns it to the State field.
