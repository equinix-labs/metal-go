...
// DeviceCreateInFacilityInputAllOf1IpAddresses struct for DeviceCreateInFacilityInputAllOf1IpAddresses
type DeviceCreateInFacilityInputAllOf1IpAddresses struct {
...
func NewDeviceCreateInFacilityInputAllOf1IpAddresses() *DeviceCreateInFacilityInputAllOf1IpAddresses {
	this := DeviceCreateInFacilityInputAllOf1IpAddresses{}
...
func (o DeviceCreateInFacilityInputAllOf1IpAddresses) MarshalJSON() ([]byte, error) {
...
type NullableDeviceCreateInFacilityInputAllOf1IpAddresses struct {
	value *DeviceCreateInFacilityInputAllOf1IpAddresses
	isSet bool
}

func (v NullableDeviceCreateInFacilityInputAllOf1IpAddresses) Get() *DeviceCreateInFacilityInputAllOf1IpAddresses {
	return v.value
}

func (v *NullableDeviceCreateInFacilityInputAllOf1IpAddresses) Set(val *DeviceCreateInFacilityInputAllOf1IpAddresses) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceCreateInFacilityInputAllOf1IpAddresses) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceCreateInFacilityInputAllOf1IpAddresses) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceCreateInFacilityInputAllOf1IpAddresses(val *DeviceCreateInFacilityInputAllOf1IpAddresses) *NullableDeviceCreateInFacilityInputAllOf1IpAddresses {
	return &NullableDeviceCreateInFacilityInputAllOf1IpAddresses{value: val, isSet: true}
}

func (v NullableDeviceCreateInFacilityInputAllOf1IpAddresses) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceCreateInFacilityInputAllOf1IpAddresses) UnmarshalJSON(src []byte) error {
	v.isSet = true
