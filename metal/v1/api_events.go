...
*/
func (a *EventsApiService) FindOrganizationEvents(ctx context.Context, organizationId string) ApiFindOrganizationEventsRequest {
	return ApiFindOrganizationEventsRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *EventsApiService) FindOrganizationEventsExecute(r ApiFindOrganizationEventsRequest) (*EventList, *http.Response, error) {
	...
	localVarPath := localBasePath + "/organizations/{organization_id}/events"
