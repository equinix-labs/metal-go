...
type NullableMetalGatewayInput struct {
	value *MetalGatewayInput
	isSet bool
}

func (v NullableMetalGatewayInput) Get() *MetalGatewayInput {
	return v.value
}

func (v *NullableMetalGatewayInput) Set(val *MetalGatewayInput) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMetalGatewayInput(val *MetalGatewayInput) *NullableMetalGatewayInput {
	return &NullableMetalGatewayInput{value: val, isSet: true}
}
