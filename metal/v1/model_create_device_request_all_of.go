...
// CreateDeviceRequestAllOf struct for CreateDeviceRequestAllOf
type CreateDeviceRequestAllOf struct {
...
func (o CreateDeviceRequestAllOf) MarshalJSON() ([]byte, error) {
...
type NullableCreateDeviceRequestAllOf struct {
	value *CreateDeviceRequestAllOf
	isSet bool
}

func (v NullableCreateDeviceRequestAllOf) Get() *CreateDeviceRequestAllOf {
	return v.value
}

func (v *NullableCreateDeviceRequestAllOf) Set(val *CreateDeviceRequestAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateDeviceRequestAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateDeviceRequestAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateDeviceRequestAllOf(val *CreateDeviceRequestAllOf) *NullableCreateDeviceRequestAllOf {
	return &NullableCreateDeviceRequestAllOf{value: val, isSet: true}
}

func (v NullableCreateDeviceRequestAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateDeviceRequestAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
