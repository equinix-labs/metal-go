...
func NewInstancesBatchCreateInputBatchesInnerAllOf() *InstancesBatchCreateInputBatchesInnerAllOf {
	this := InstancesBatchCreateInputBatchesInnerAllOf{}
	return &this
}
...
type NullableInstancesBatchCreateInputBatchesInnerAllOf struct {
	value *InstancesBatchCreateInputBatchesInnerAllOf
	isSet bool
}

func (v NullableInstancesBatchCreateInputBatchesInnerAllOf) Get() *InstancesBatchCreateInputBatchesInnerAllOf {
	return v.value
}

func (v *NullableInstancesBatchCreateInputBatchesInnerAllOf) Set(val *InstancesBatchCreateInputBatchesInnerAllOf) {
	v.value = val
	v.isSet = true
}

func (v NullableInstancesBatchCreateInputBatchesInnerAllOf) IsSet() bool {
	return v.isSet
}

func (v *NullableInstancesBatchCreateInputBatchesInnerAllOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInstancesBatchCreateInputBatchesInnerAllOf(val *InstancesBatchCreateInputBatchesInnerAllOf) *NullableInstancesBatchCreateInputBatchesInnerAllOf {
	return &NullableInstancesBatchCreateInputBatchesInnerAllOf{value: val, isSet: true}
}

func (v NullableInstancesBatchCreateInputBatchesInnerAllOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInstancesBatchCreateInputBatchesInnerAllOf) UnmarshalJSON(src []byte) error {
	v.isSet = true
