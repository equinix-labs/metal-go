...
// List of BgpConfigRequestInputDeploymentType
const (
	BGPCONFIGREQUESTINPUT_LOCAL  BgpConfigRequestInputDeploymentType = "local"
	BGPCONFIGREQUESTINPUT_GLOBAL BgpConfigRequestInputDeploymentType = "global"
)
