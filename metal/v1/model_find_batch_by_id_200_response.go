...
type NullableFindBatchById200Response struct {
	value *FindBatchById200Response
	isSet bool
}

func (v NullableFindBatchById200Response) Get() *FindBatchById200Response {
	return v.value
}

func (v *NullableFindBatchById200Response) Set(val *FindBatchById200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableFindBatchById200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableFindBatchById200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFindBatchById200Response(val *FindBatchById200Response) *NullableFindBatchById200Response {
	return &NullableFindBatchById200Response{value: val, isSet: true}
}
