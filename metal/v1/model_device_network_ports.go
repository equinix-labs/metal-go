...
// DeviceNetworkPorts struct for DeviceNetworkPorts
type DeviceNetworkPorts struct {
...
func (o DeviceNetworkPorts) MarshalJSON() ([]byte, error) {
...
type NullableDeviceNetworkPorts struct {
	value *DeviceNetworkPorts
	isSet bool
}

func (v NullableDeviceNetworkPorts) Get() *DeviceNetworkPorts {
	return v.value
}

func (v *NullableDeviceNetworkPorts) Set(val *DeviceNetworkPorts) {
	v.value = val
	v.isSet = true
}

func (v NullableDeviceNetworkPorts) IsSet() bool {
	return v.isSet
}

func (v *NullableDeviceNetworkPorts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeviceNetworkPorts(val *DeviceNetworkPorts) *NullableDeviceNetworkPorts {
	return &NullableDeviceNetworkPorts{value: val, isSet: true}
}

func (v NullableDeviceNetworkPorts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeviceNetworkPorts) UnmarshalJSON(src []byte) error {
	v.isSet = true
