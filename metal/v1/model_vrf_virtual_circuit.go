...
type VrfVirtualCircuit struct {
	...
	Type                 *VrfVirtualCircuitType `json:"type,omitempty"`
	Vrf                  Vrf                    `json:"vrf"`
...
// SetType gets a reference to the given VrfVirtualCircuitType and assigns it to the Type field.
