...
type BgpNeighborData struct {
	...
	PeerIps []*BgpNeighborDataPeerIpsItems0 `json:"peer_ips"`
...
func (m *BgpNeighborData) Validate(formats strfmt.Registry) error {
	...
	if err := m.validatePeerIps(formats); err != nil {
		res = append(res, err)
	}
...
func (m *BgpNeighborData) validatePeerIps(formats strfmt.Registry) error {

	if swag.IsZero(m.PeerIps) { // not required
		return nil
	}

	for i := 0; i < len(m.PeerIps); i++ {
		if swag.IsZero(m.PeerIps[i]) { // not required
			continue
		}

		if m.PeerIps[i] != nil {
			if err := m.PeerIps[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					return ve.ValidateName("peer_ips" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
// BgpNeighborDataPeerIpsItems0 bgp neighbor data peer ips items0
//
// swagger:model BgpNeighborDataPeerIpsItems0
type BgpNeighborDataPeerIpsItems0 struct {
...
// Validate validates this bgp neighbor data peer ips items0
func (m *BgpNeighborDataPeerIpsItems0) Validate(formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *BgpNeighborDataPeerIpsItems0) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
	return swag.WriteJSON(m)
...
// UnmarshalBinary interface implementation
func (m *BgpNeighborDataPeerIpsItems0) UnmarshalBinary(b []byte) error {
	var res BgpNeighborDataPeerIpsItems0
	if err := swag.ReadJSON(b, &res); err != nil {
		return err
	}
	*m = res
