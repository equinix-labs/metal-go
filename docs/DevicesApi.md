...
func main() {
    ...
    createDeviceRequest := openapiclient.createDevice_request{DeviceCreateInFacilityInput: openapiclient.NewDeviceCreateInFacilityInput(*openapiclient.NewDeviceCreateInFacilityInputAllOfFacility(), "OperatingSystem_example", "c3.large.x86")} // CreateDeviceRequest | Device to create
